    ...
    <div className=' bg-[#F6F9FC] text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32'>
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                <div className='max-w-80'>
                    ...
                    <p className='text-sm'>
                        Discover the world's most extraordinary places to stay with QuickStay. From luxurious resorts to charming boutique hotels, we offer handpicked accommodations that promise unforgettable experiences.
                    </p>
